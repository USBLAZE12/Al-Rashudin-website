      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="w-11 h-11 bg-red-600 group-hover:bg-red-700 rounded-xl flex items-center justify-center shadow-md shadow-red-500/20 transition-colors">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <a
              ...
              className="flex items-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-colors shadow-xs"
            >
            ...
            <Link
              href="/contact"
              className="bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors shadow-sm shadow-red-500/20"
            >
              Get Quote
            </Link>
          </div>
            ...
            <div className="px-4 py-6 space-y-3">
              ...
              <div className="pt-4 space-y-3 border-t border-slate-800">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center space-x-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-3 rounded-xl text-sm font-semibold"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="block text-center bg-red-600 hover:bg-red-700 text-white px-4 py-3 rounded-xl text-sm font-semibold transition-colors"
                >
                  Request a Quote
                </Link>
              </div>
