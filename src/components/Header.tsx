      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Al Rashudin</h1>
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navigation.map((item) => (
              <Link
                key={item.name}
                href={item.href}
                className="animated-underline text-sm font-medium text-gray-300 hover:text-white"
              >
                {item.name}
              </Link>
            ))}
            ...
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 space-y-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-4 py-3 rounded-lg text-sm font-medium"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="block text-center bg-primary hover:bg-primary-dark text-white px-6 py-3 rounded-lg text-sm font-medium"
                >
                  Get Quote
                </Link>
              </div>
