        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <span className="inline-block bg-white/20 backdrop-blur-xs text-white text-xs font-bold uppercase tracking-wider px-3.5 py-1.5 rounded-full mb-4">
              Custom Engineering & Overhauls
            </span>
            <h2 className="text-3xl sm:text-4xl font-extrabold mb-4 tracking-tight">
              Need a Custom Machine or Cylinder Solution?
            </h2>
            <p className="text-red-100 text-sm sm:text-base max-w-xl mx-auto mb-8 leading-relaxed">
              Send your dimensional drawings, machine details, or damaged parts.
              Our technicians will evaluate tolerances and provide a rapid, competitive solution.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
                  "Hello, I need custom hydraulic engineering or repair support."
                )}`}
                target="_blank"
