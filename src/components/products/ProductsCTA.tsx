            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
                  "Hello Al Rashudin Engineering, I need assistance finding a specific seal or heavy equipment part."
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white hover:bg-slate-100 text-slate-900 px-8 py-3.5 rounded-xl font-bold transition-all shadow-md hover:shadow-lg inline-flex items-center justify-center"
              >
                <svg
              ...
              <Link
                href="/contact"
                className="bg-red-900/60 hover:bg-red-950 text-white border border-white/30 px-8 py-3.5 rounded-xl font-bold transition-all shadow-md inline-flex items-center justify-center"
              >
                Send Part Inquiry Form
              </Link>
            </div>
          </div>
        </motion.div>
