        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <a
              ...
              className="bg-white hover:bg-slate-100 text-slate-900 px-8 py-4 rounded-xl text-base font-bold transition-all shadow-lg hover:shadow-xl inline-flex items-center justify-center"
            >
              <svg
                className="w-5 h-5 mr-2.5 text-emerald-600"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <Link
              ...
              className="bg-red-950/60 hover:bg-red-950 text-white border border-white/30 px-8 py-4 rounded-xl text-base font-bold transition-all shadow-lg inline-flex items-center justify-center"
            >
              <span>Send Online RFQ Form</span>
              <svg
