    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="max-w-3xl">
          ...
          >
            <span className="w-2 h-2 bg-primary rounded-full pulse-animation" />
            <span className="text-primary text-sm font-medium">
              Industrial Excellence in UAE
            </span>
          </motion.div>
          ...
          >
            Hydraulic Seals &{" "}
            <span className="gradient-text">Crane Components</span>
          </motion.h1>
          ...
          >
            Al Rashudin Engineering specializes in premium hydraulic seal kits,
            crane components, and industrial parts. We deliver reliable,
            OEM-quality solutions for heavy equipment across UAE and
            internationally.
          </motion.p>
          ...
          >
            ...
            <div className="flex space-x-4">
              {[
                ...
                {
                  name: "Facebook",
                  href: "https://facebook.com/alrashudin",
                  icon: (
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                ...
                {
                  name: "Instagram",
                  href: "https://instagram.com/alrashudin",
                  icon: (
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                ...
                {
                  name: "LinkedIn",
                  href: "https://linkedin.com/company/alrashudin",
                  icon: (
                    <svg
                      className="w-5 h-5"
                      fill="currentColor"
                ...
                <a
                  ...
                  className="w-10 h-10 bg-white/10 hover:bg-primary rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-colors"
